...
TextToSpeechRequest _$TextToSpeechRequestFromJson(Map<String, dynamic> json) => TextToSpeechRequest(
      voiceId: json['voice_id'] as String,
      modelId: json['model_id'] as String? ?? "eleven_monolingual_v1",
      text: json['text'] as String,
      voiceSettings: json['voice_settings'] == null
          ? null
          : VoiceSettings.fromJson(json['voice_settings'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$TextToSpeechRequestToJson(TextToSpeechRequest instance) => <String, dynamic>{
...
VoiceSettings _$VoiceSettingsFromJson(Map<String, dynamic> json) => VoiceSettings(
      similarityBoost: (json['similarity_boost'] as num).toDouble(),
      stability: (json['stability'] as num).toDouble(),
    );

Map<String, dynamic> _$VoiceSettingsToJson(VoiceSettings instance) => <String, dynamic>{
      'similarity_boost': instance.similarityBoost,
      'stability': instance.stability,
    };

TextToSpeechStreamRequest _$TextToSpeechStreamRequestFromJson(Map<String, dynamic> json) => TextToSpeechStreamRequest(
...
Map<String, dynamic> _$TextToSpeechStreamRequestToJson(TextToSpeechStreamRequest instance) => <String, dynamic>{
      'model_id': instance.modelId,
      'text': instance.text,
      'voice_settings': instance.voiceSettings,
    };
...
Map<String, dynamic> _$ElevenModelToJson(ElevenModel instance) => <String, dynamic>{
...
Voice _$VoiceFromJson(Map<String, dynamic> json) => Voice(
      availableForTiers: (json['available_for_tiers'] as List<dynamic>?)?.map((e) => e as String).toList(),
      category: json['category'] as String,
      description: json['description'] as String?,
      fineTuning: FineTuning.fromJson(json['fine_tuning'] as Map<String, dynamic>),
      name: json['name'] as String,
      language: json['language'] as String?,
      labels: json['labels'] == null ? null : Labels.fromJson(json['labels'] as Map<String, dynamic>),
      previewUrl: json['preview_url'] as String,
      samples: (json['samples'] as List<dynamic>?)?.map((e) => Sample.fromJson(e as Map<String, dynamic>)).toList(),
      settings: json['settings'] == null
          ? const VoiceSettings(similarityBoost: 0.5, stability: 0.75)
          : VoiceSettings.fromJson(json['settings'] as Map<String, dynamic>),
      sharing: json['sharing'] == null ? null : Sharing.fromJson(json['sharing'] as Map<String, dynamic>),
      voiceId: json['voice_id'] as String,
    );
...
FineTuning _$FineTuningFromJson(Map<String, dynamic> json) => FineTuning(
      fineTuningRequested: (json['fine_tuning_requested'] as bool?) ?? false,
      fineTuningState: const FineTuningStateConverter().fromJson(json['finetuning_state'] as String? ?? ""),
      isAllowedToFineTune: (json['is_allowed_to_fine_tune'] as bool?) ?? false,
      language: json['language'] == null ? null : Language.fromJson(json['language'] as Map<String, dynamic>),
      modelId: json['model_id'] as String?,
      sliceIds: (json['slice_ids'] as List<dynamic>?)?.map((e) => e as String).toList(),
      verificationAttempts: (json['verification_attempts'] as List<dynamic>?)
          ...
          .toList(),
      verificationAttemptsCount: json['verification_attempts_count'] as int? ?? 0,
      verificationFailures: (json['verification_failures'] as List<dynamic>?)?.map((e) => e as String).toList() ?? [],
      manualVerification: json['manual_verification'] as bool?,
    );

Map<String, dynamic> _$FineTuningToJson(FineTuning instance) => <String, dynamic>{
      'fine_tuning_requested': instance.fineTuningRequested,
      'finetuning_state': const FineTuningStateConverter().toJson(instance.fineTuningState),
...
VerificationAttempt _$VerificationAttemptFromJson(Map<String, dynamic> json) => VerificationAttempt(
...
Map<String, dynamic> _$VerificationAttemptToJson(VerificationAttempt instance) => <String, dynamic>{
...
AddVoiceRequest _$AddVoiceRequestFromJson(Map<String, dynamic> json) => AddVoiceRequest(
      description: json['description'] as String?,
...
Map<String, dynamic> _$AddVoiceRequestToJson(AddVoiceRequest instance) => <String, dynamic>{
      'description': instance.description,
...
AddVoiceResponse _$AddVoiceResponseFromJson(Map<String, dynamic> json) => AddVoiceResponse(
      voiceId: json['voice_id'] as String,
    );

Map<String, dynamic> _$AddVoiceResponseToJson(AddVoiceResponse instance) => <String, dynamic>{
      'voice_id': instance.voiceId,
    };

EditVoiceRequest _$EditVoiceRequestFromJson(Map<String, dynamic> json) => EditVoiceRequest(
      description: json['description'] as String?,
      files: (json['files'] as List<dynamic>?)?.map((e) => e as String).toList(),
      labels: json['labels'] as String?,
      name: json['name'] as String,
...
Map<String, dynamic> _$EditVoiceRequestToJson(EditVoiceRequest instance) => <String, dynamic>{
      'description': instance.description,
      'files': instance.files,
      'labels': instance.labels,
      'name': instance.name,
...
History _$HistoryFromJson(Map<String, dynamic> json) => History(
      ...
      history: (json['history'] as List<dynamic>).map((e) => HistoryItem.fromJson(e as Map<String, dynamic>)).toList(),
...
HistoryItem _$HistoryItemFromJson(Map<String, dynamic> json) => HistoryItem(
      ...
      settings: VoiceSettings.fromJson(json['settings'] as Map<String, dynamic>),
...
Map<String, dynamic> _$HistoryItemToJson(HistoryItem instance) => <String, dynamic>{
...
DownloadHistoryItemsRequest _$DownloadHistoryItemsRequestFromJson(Map<String, dynamic> json) =>
    DownloadHistoryItemsRequest(
      historyItemIds: (json['history_item_ids'] as List<dynamic>).map((e) => e as String).toList(),
    );

Map<String, dynamic> _$DownloadHistoryItemsRequestToJson(DownloadHistoryItemsRequest instance) => <String, dynamic>{
      'history_item_ids': instance.historyItemIds,
    };

ElevenUser _$ElevenUserFromJson(Map<String, dynamic> json) => ElevenUser(
      canUseDelayedPaymentMethods: json['can_use_delayed_payment_methods'] as bool,
      isNewUser: json['is_new_user'] as bool,
      subscription: SubscriptionInfo.fromJson(json['subscription'] as Map<String, dynamic>),
      xiApiKey: json['xi_api_key'] as String,
    );

Map<String, dynamic> _$ElevenUserToJson(ElevenUser instance) => <String, dynamic>{
...
SubscriptionInfo _$SubscriptionInfoFromJson(Map<String, dynamic> json) => SubscriptionInfo(
      allowedToExtendCharacterLimit: json['allowed_to_extend_character_limit'] as bool,
      ...
      canUseProfessionalVoiceCloning: json['can_use_professional_voice_cloning'] as bool,
      characterCount: json['character_count'] as int,
      characterLimit: json['character_limit'] as int,
      currency: json['currency'] as String,
      nextCharacterCountResetUnix: json['next_character_count_reset_unix'] as int,
...
Map<String, dynamic> _$SubscriptionInfoToJson(SubscriptionInfo instance) => <String, dynamic>{
...
ExtendedSubscriptionInfo _$ExtendedSubscriptionInfoFromJson(Map<String, dynamic> json) => ExtendedSubscriptionInfo(
      allowedToExtendCharacterLimit: json['allowed_to_extend_character_limit'] as bool,
      canExtendCharacterLimit: json['can_extend_character_limit'] as bool,
      canExtendVoiceLimit: json['can_extend_voice_limit'] as bool,
      canUseInstantVoiceCloning: json['can_use_instant_voice_cloning'] as bool,
      ...
      nextInvoice: NextInvoice.fromJson(json['next_invoice'] as Map<String, dynamic>),
      professionalVoiceLimit: json['professional_voice_limit'] as int,
      status: json['status'] as String,
      tier: json['tier'] as String,
      voiceLimit: json['voice_limit'] as int,
...
Map<String, dynamic> _$ExtendedSubscriptionInfoToJson(ExtendedSubscriptionInfo instance) => <String, dynamic>{
      'allowed_to_extend_character_limit': instance.allowedToExtendCharacterLimit,
      'can_extend_character_limit': instance.canExtendCharacterLimit,
      'can_extend_voice_limit': instance.canExtendVoiceLimit,
      'can_use_instant_voice_cloning': instance.canUseInstantVoiceCloning,
...
Map<String, dynamic> _$NextInvoiceToJson(NextInvoice instance) => <String, dynamic>{
